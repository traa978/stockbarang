...
require "service/datamasuk.php";

$sql = "SELECT * FROM barangmasuk m, stock s where s.idbarang = m.idbarang";
$result = $db->query($sql);
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Tambah Stock Barang</h1>
        ...
        <script>
            ...
            $('select[name="databarangmasuk"]').on('change', function () {
  ...
  <div class="modal-dialog">
    ...
    <form method="POST">
        <div class="modal-body">
            <select class="form-control mb-2" name="databarangmasuk" required>
            ...
            <input class="form-control mb-2" type="text" placeholder="Keterangan" name="keterangan" required>
            <input class="form-control mb-2" type="number" placeholder="Qty" name="qty" required>
            <div class="modal-footer">
                <button type="submit" class="btn btn-info" name="tambahstock">Tambah</button>
            </div>
        </div>
    </form>
    </div>
